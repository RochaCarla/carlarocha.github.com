...
<section class="section">
  <div class="container"><div class="max-w-6xl">
    ...
    <div class="category-section">
      <h2 class="section-title"><span class="icon">🎓</span> Trabalho de Conclusão de Curso</h2>
    ...
    <div class="category-section">
      <h2 class="section-title"><span class="icon">📚</span> Leitura Obrigatória</h2>
      <div class="reading-grid">
        <div class="reading-card">
    ...
    <div class="category-section">
      <h2 class="section-title"><span class="icon">✍️</span> Escrita de Artigos</h2>
      <div class="reading-grid">
        <div class="reading-card">
    ...
    <div class="category-section">
      <h2 class="section-title"><span class="icon">🎤</span> Apresentações</h2>
      <div class="reading-grid">
        <div class="reading-card">
    ...
    <div class="category-section">
      <h2 class="section-title"><span class="icon">💪</span> Rejeições</h2>
      <div class="reading-grid">
        <div class="reading-card">
    ...
    <div class="category-section">
      <h2 class="section-title"><span class="icon">🌟</span> Tópicos Gerais</h2>
      <div class="reading-grid">
        <div class="reading-card">
